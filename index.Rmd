...
AVOCADO: The image above isn't showing up in the html?
...
3. How to pivot between "long" and "wide" data sets
4. Joining together multiple data sets using `dplyr`
...
An important limitation regarding this data analysis to keep in mind is the data sets only include countries and years in which countries were reporting such information to the agencies that collected the data. 
...
AVOCADO: when I compile the HTML, I see the HW in the data viz section. do you see the same? 
