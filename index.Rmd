...
This allows us to use our `CO2_emissions` data and use it in combination with the `<-` assignment operator to reassign it to a modified version of the object. 
