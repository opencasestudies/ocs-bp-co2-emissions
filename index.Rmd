...
We will use the `facet_wrap()` function of the `ggplot2` package, which plots multiple subplots simultaneously. 
...
Next, let's compare how two variables relate to each other (e.g. CO2 emissions and temperature). 
