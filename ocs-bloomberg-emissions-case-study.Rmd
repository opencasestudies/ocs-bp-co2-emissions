...
In this case study we will be using data related to CO2 emissions, as well as other data that may influence, be influenced or relate to CO2 emissions. Most of our data was obtained from [Gapminder](https://www.gapminder.org/data/), which is a unique nonprofit that provides a variety of data for free.
...
Data   | Source         | Orginal Source   | Description | Citation                                                                    
---------- |-------------|-------------|-------------
**CO2 emissions**  | [Gapminder](https://www.gapminder.org/data/) | [Carbon Dioxid Information Analysis Center (CDIAC)](https://cdiac.ess-dive.lbl.gov/) |  CO2 emissions in metric tonnes per person | NA
**GDP per capita, yearly growth**  | [Gapminder](https://www.gapminder.org/data/) | [World Bank](https://data.worldbank.org/indicator/NY.GDP.PCAP.KD.ZG) |  [Growth Domestic Product](https://www.investopedia.com/terms/g/gdp.asp#:~:text=Gross%20Domestic%20Product%20(GDP)%20is%20the%20monetary%20value%20of%20all,expenditures%2C%20production%2C%20or%20incomes.) (which is a measure of economic status) per person | NA
**Energy use per person**  | [Gapminder](https://www.gapminder.org/data/) | [World Bank](https://data.worldbank.org/indicator/EG.USE.PCAP.KG.OE) |  Use of primary energy before transformation to other end-use fules, by country starting in 1960 | NA
**Crude Mortality Rate**  | [World Bank](https://data.worldbank.org/indicator/SP.DYN.CDRT.IN) | [World Bank](https://data.worldbank.org/indicator/SP.DYN.CDRT.IN)|  Death rate per 1,000 people from 1960 to 2018 by country| NA 
**US Natural Disasters**  | [The National Oceanic and Atmospheric Administration (NOAA)](https://www.ncdc.noaa.gov/billions/time-series)| [The National Oceanic and Atmospheric Administration (NOAA) ](https://www.ncdc.noaa.gov/billions/time-series)|  Data from 1980 to 2019 including: <br> -- Drought Count <br> -- Flooding Count <br> -- Freeze Count <br> -- Severe Storm Count <br> -- Tropical Cyclone Count <br> -- Wildfire Count <br> -- Winter Storm Count | NOAA National Centers for Environmental Information (NCEI) U.S. Billion-Dollar Weather and Climate Disasters (2020). https://www.ncdc.noaa.gov/billions/, DOI: 10.25921/stkw-7w73
**Temperature**  | [The National Oceanic and Atmospheric Administration (NOAA)](https://www.ncdc.noaa.gov/cag/global/time-series/globe/land_ocean/ytd/5/1880-2020)  | [The National Oceanic and Atmospheric Administration (NOAA)](https://www.ncdc.noaa.gov/cag/global/time-series/globe/land_ocean/ytd/5/1880-2020) | National yearly average temperature (in Fahrenheit) from 1980 to 2019 | NOAA National Centers for Environmental Information, State of the Climate: Global Climate Report for March 2020, published online April 2020, retrieved on June 25, 2020 from https://www.ncdc.noaa.gov/sotc/global/202003/supplemental/page-1.

not quite right... almost...
https://www.ncdc.noaa.gov/cag/national/time-series/110/tavg/12/5/1895-2020?base_prd=true&begbaseyear=1901&endbaseyear=2000
...
**variable2**  | Variable info  <br> -- more details <br> -- more detials <br>  **Example**: Content content | source | Description
