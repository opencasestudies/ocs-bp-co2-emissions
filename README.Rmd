...
This case study particularly focuses on renaming variables, modifying variables, creating new variables, and modifying the shape of the data using functions from the `dplyr` package such as: `rename()`, `mutate()`, `pivot_longer()`, and `pivot_wider()`. 
...
In this case study we look at the correlation between CO2 emissions and annual average temperatures in the US. We also evaluate the assocation between the two using a linear regression. We discuss the relationship between correlation and linear regression and how we interpret the findings.
...
[National Climate Assessment Report](https://toolkit.climate.gov/sites/default/files/2025-07/NCA5_2023_FullReport.pdf){target="_blank"}    
